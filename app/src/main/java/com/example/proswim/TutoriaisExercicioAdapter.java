...
public class TutoriaisExercicioAdapter extends RecyclerView.Adapter<TutoriaisExercicioAdapter.ExercicioViewHolder> {
    ...
    public TutoriaisExercicioAdapter(List<Integer> videos, List<String> titles, List<Integer> covers) {
